...
def check(fs,fd):
    if fs == fd:
        ...
        while (count < 4):
            ...
            #check MD5
            check1 = os.popen('cat md5sums | grep pmu851.axf | cut -c 1-32')
            check2 = os.popen('md5sum pmu851.axf | cut -c 1-32')
            ck1 =  check1.read()
            ck2 =  check2.read()
...
if __name__ == '__main__':
    ...
    srcfile = '/home/factory/Avalon-extras/scripts/factory/pmu851.axf'
    dstfile = '/home/factory/canaan_factory/pmu851.axf'
